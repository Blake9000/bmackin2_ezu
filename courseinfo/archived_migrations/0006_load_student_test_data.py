...
def remove_student_data(apps, schema_editor):
    student_class = apps.get_model('courseinfo', 'Student')
    registration_class = apps.get_model('courseinfo', 'Registration')

    db_alias = schema_editor.connection.alias

    for student in STUDENTS:
        try:
            student_object = student_class.objects.using(db_alias).get(
                first_name=student['first_name'],
                last_name=student['last_name'],
                disambiguator=student['disambiguator']
            )

            registration_class.objects.using(db_alias).filter(
            ...
            print('Student entry not found during rollback:', student['first_name'], student['last_name'])
