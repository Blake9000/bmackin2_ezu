...
class InstructorDelete(LoginRequiredMixin, PermissionRequiredMixin, DeleteView):
    ...
    def get(self, request, pk):
        ...
        if sections.count() > 0:
            return render(request, 'courseinfo/instructor_refuse_delete.html', {'instructor': instructor, 'sections': sections})
...
class SectionDelete(LoginRequiredMixin, PermissionRequiredMixin, DeleteView):
    ...
    def get(self, request, pk):
        ...
        if registrations.count() > 0:
            return render(request, 'courseinfo/section_refuse_delete.html', {'section': section, 'registrations': registrations})
...
class SemesterDetail(LoginRequiredMixin, PermissionRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        context = super(SemesterDetail, self).get_context_data(**kwargs)
